...
export default function ContatoPage() {
  ...
  return (
    <section className="container-custom py-12 grid md:grid-cols-2 gap-10">
      <div>
        <h1 className="text-3xl font-heading font-bold text-primary-800 mb-6">Contato</h1>
        <p className="text-gray-600 mb-6">Fale connosco para parcerias, dúvidas e informações.</p>
        <div className="space-y-4 text-gray-700">
          <div className="flex items-center space-x-3"><Mail size={18} /><span>contato@associacaodeporcos.ao</span></div>
          <div className="flex items-center space-x-3"><Phone size={18} /><span>(+244) 222 123 456</span></div>
        </div>
      </div>
      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow p-6 space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input name="subject" required className="w-full border rounded px-3 py-2" />
          </div>
        </div>
        <div>
