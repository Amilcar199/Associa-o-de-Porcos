export default {
	...
	auth: {
		...
		passwordMin: 'Minimum 8 characters, with uppercase, number and symbol',
		...
		errorPasswordTooShort: 'Password must be at least 8 characters, with uppercase, lowercase, number and symbol',
	...
	profile: {
		...
		pushNotif: { title: 'Browser notifications', desc: 'Get alerts when the site is open or installed' },
