export default {
	...
	auth: {
		...
		passwordMin: 'Mínimo 8 caracteres, com maiúscula, número e símbolo',
		...
		errorPasswordTooShort: 'A senha deve ter pelo menos 8 caracteres, com maiúscula, minúscula, número e símbolo',
