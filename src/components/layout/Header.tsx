              ...
              {status === 'loading' ? (
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <Link 
                    href="/registro" 
                    prefetch
                    className="btn-primary rounded-full px-5 py-2.5 whitespace-nowrap ml-3"
                  >
                    {dict.user.signup}
                  </Link>
                </div>
        ...
        <div className="container-custom">
          <div className="flex items-center justify-between h-20 lg:h-36">
            ...
            <Link href="/" className="flex items-center space-x-3 lg:space-x-5">
              <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-36 lg:h-36 relative">
                {siteConfig?.logoUrl ? (
                  ...
                  <Image
                    ...
                    sizes="(max-width: 640px) 56px, (max-width: 768px) 64px, (max-width: 1024px) 80px, 144px"
                    priority
                  />
                )}
              </div>
            ...
            <div className="hidden lg:flex items-center gap-5 lg:ml-8 xl:ml-10 text-white">
              {session ? (
                ...
                <div className="flex items-center space-x-5">
                  ...
                  <Link
                    href="/registro"
                    className="btn-primary rounded-full px-5 py-2.5 whitespace-nowrap ml-4"
                  >
                    {dict.user.signup}
                  </Link>
                  <HeaderLanguageMenu />
                ...
                <nav className="space-y-4">
                  ...
                  {session ? (
                    ...
                    <div className="pt-4 border-t border-gray-200 space-y-4">
                      ...
                      <Link
                        href="/registro"
                        className="btn-primary rounded-full px-5 py-2.5 inline-block mt-2"
                      >
                        {dict.user.signup}
                      </Link>
                      <div>
